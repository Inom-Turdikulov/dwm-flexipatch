...
#else
static const char *fonts[]               = { "monospace:size=15:antialias=false:autohint=true" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "monospace:size=15:antialias=false:autohint=true";
...
static char selfloatcolor[]              = "#E06C75";
...
static char titleselbordercolor[]        = "#E06C75";
...
static const Key keys[] = {
 ...
 //    { MODKEY, XK_t, spawn, SHCMD("maim -s | tesseract stdin stdout | crow -p -i -t en+ru") },
	...
	{ Mod1Mask, XF86XK_AudioPlay,        spawn, SHCMD("playerctl -p firefox play-pause") },
	{ ControlMask, XF86XK_AudioPlay,        spawn, SHCMD("playerctl -p $AUDIO_PLAYER play-pause") },
	...
	{ Mod3Mask|Mod1Mask,                     XK_t,            floatpos,               {.v = " 26x   0y" } }, // →
	{ Mod3Mask|Mod1Mask,                     XK_x,            floatpos,               {.v = "-26x  26y" } }, // ↙
	{ Mod3Mask|Mod1Mask,                     XK_s,            floatpos,               {.v = "  0x  26y" } }, // ↓
	{ Mod3Mask|Mod1Mask,                     XK_d,            floatpos,               {.v = " 26x  26y" } }, // ↘
	/* Absolut|Mod1Maske positioning (allows moving windows between monitors) */
	...
	{ Mod3Mask,            XK_w,            floatpos,               {.v = "-1p -1p" } }, // ↖
	{ Mod3Mask,            XK_f,            floatpos,               {.v = " 0p -1p" } }, // ↑
	{ Mod3Mask,            XK_p,            floatpos,               {.v = " 1p -1p" } }, // ↗
	{ Mod3Mask,            XK_r,            floatpos,               {.v = "-1p  0p" } }, // ←
	{ Mod3Mask,            XK_c,            floatpos,               {.v = " 0p  0p" } }, // ·
	{ Mod3Mask,            XK_t,            floatpos,               {.v = " 1p  0p" } }, // →
	{ Mod3Mask,            XK_x,            floatpos,               {.v = "-1p  1p" } }, // ↙
	{ Mod3Mask,            XK_s,            floatpos,               {.v = " 0p  1p" } }, // ↓
	{ Mod3Mask,            XK_d,            floatpos,               {.v = " 1p  1p" } }, // ↘
	#endif // FLOATPOS_PATCH
